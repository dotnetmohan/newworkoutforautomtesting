...
namespace AutomationTest.Tests.Features
{
    ...
    public partial class ProductsAPITestingFeature : object, global::Xunit.IClassFixture<ProductsAPITestingFeature.FixtureData>, global::Xunit.IAsyncLifetime
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Features", "Products API Testing", "    As an API consumer\r\n    I want to test the Products API endpoints\r\n    So tha" +
                "t I can ensure they work correctly", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags, InitializeCucumberMessages());
        
        private global::Xunit.Abstractions.ITestOutputHelper _testOutputHelper;
        
#line 1 "Products.reqnroll.feature"
#line hidden
        
        public ProductsAPITestingFeature(ProductsAPITestingFeature.FixtureData fixtureData, global::Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Features/Products.reqnroll.feature.ndjson", 5);
        }
...
#line 7
    await testRunner.WhenAsync("I send a GET request to \"/products\"", ((string)(null)), ((global::Reqnroll.Table)(null)), "When ");
#line hidden
#line 8
...
#line hidden
#line 14
    await testRunner.AndAsync("the response should contain product details", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
...
#line hidden
            ...
            else
            {
                await this.ScenarioStartAsync();
#line 17
    await testRunner.WhenAsync("I send a GET request to \"/products/search?q=phone\"", ((string)(null)), ((global::Reqnroll.Table)(null)), "When ");
#line hidden
#line 18
    await testRunner.ThenAsync("the response status code should be 200", ((string)(null)), ((global::Reqnroll.Table)(null)), "Then ");
#line hidden
#line 19
    await testRunner.AndAsync("the response should contain matching products", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
        ...
        public class FixtureData : object, global::Xunit.IAsyncLifetime
        {
            ...
            async global::System.Threading.Tasks.Task global::Xunit.IAsyncLifetime.InitializeAsync()
            {
                await ProductsAPITestingFeature.FeatureSetupAsync();
            }
            
            async global::System.Threading.Tasks.Task global::Xunit.IAsyncLifetime.DisposeAsync()
            {
                await ProductsAPITestingFeature.FeatureTearDownAsync();
            }
        }
    }
}
